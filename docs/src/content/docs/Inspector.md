...
- [`<SimpleFormConfigurable>`](./SimpleFormConfigurable.md) for a ready-made configurable form
- [`<ColumnsButton>`](./ColumnsButton.md) for a non-inspector approach to column visibility
