...
For the conventional Filter + Create + Export combo, use [`<ListActions>`](./ListActions.md) instead — it composes the same buttons and reads the resource definition automatically.
