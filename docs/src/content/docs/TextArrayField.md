...
Renders an array of scalar values as a horizontal list of shadcn [`<Badge>`](https://ui.shadcn.com/docs/components/badge) components. Useful for tags, genres, or similar short string arrays.
