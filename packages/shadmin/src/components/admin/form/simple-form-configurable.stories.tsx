...
import { Edit } from "@/components/admin/views/edit";
import { SimpleFormConfigurable } from "@/components/admin/form/simple-form-configurable";
import { TextInput } from "@/components/admin/inputs/text-input";
import { ListGuesser } from "@/components/admin/guessers/list-guesser";
import { InspectorButton } from "@/components/admin/buttons/inspector-button";
