...
import { Basic, EmptyValue } from "./shapes/multi-line-string-field.stories";
...
describe("<MultiLineStringField />", () => {
  it("renders multiple polyline paths from a MultiLineString geometry", async () => {
