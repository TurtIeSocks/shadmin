...
const customEnglishMessages: TranslationMessages = {
  ...
  pos: {
    ...
    dashboard: {
      ...
      welcome: {
        title: "Welcome to the shadmin e-commerce demo",
        subtitle:
          "This is the admin of an imaginary poster shop. Feel free to explore and modify the data - it's local to your computer, and will reset each time you reload.",
        ra_button: "shadmin site",
  ...
  resources: {
    ...
    tags: {
      ...
      notifications: {
        created: "Tag created |||| %{smart_count} tags created",
        updated: "Tag updated |||| %{smart_count} tags updated",
        deleted: "Tag deleted |||| %{smart_count} tags deleted",
      },
    },
    segments: {
