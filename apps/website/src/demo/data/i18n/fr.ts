import type { TranslationMessages } from "shadmin-core";
...
const customFrenchMessages: TranslationMessages = {
  ...
  pos: {
    ...
    dashboard: {
      ...
      welcome: {
        title: "Bienvenue sur la démo e-commerce de shadmin",
        subtitle:
  ...
  resources: {
    ...
    tags: {
      ...
      notifications: {
        created: "Tag créé |||| %{smart_count} tags créés",
        updated: "Tag mis à jour |||| %{smart_count} tags mis à jour",
        deleted: "Tag supprimé |||| %{smart_count} tags supprimés",
      },
    },
    segments: {
