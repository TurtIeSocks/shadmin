      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="relative">
          <button
            ...
            aria-label={
              expanded ? "Show fewer customers" : "Show more customers"
            }
            onClick={() => setExpanded((e) => !e)}
            className="absolute inset-0 z-10 hidden w-full md:block md:cursor-pointer"
          />
          <ul
            className={classNames(
              "mx-auto flex flex-wrap items-center justify-center gap-x-8 gap-y-12 overflow-hidden transition-all",
