...
| --------------- | -------- | --------------------- | ---------------------- | -------------------------------------- |
| `source`        | Required | `string`              | -                      | Record field holding the `MultiPoint`. |
...
| `pathOptions`   | Optional | `L.PathOptions`       | `{ color: "#3388ff" }` | Vector styling.                        |
| `markerIcon`    | Optional | `L.Icon \| L.DivIcon` | shared `MarkerIcon`    | Icon for each point.                   |
