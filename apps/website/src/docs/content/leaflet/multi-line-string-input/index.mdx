...
description: "Form input for drawing a GeoJSON.MultiLineString. Each drawn polyline is combined into a single MultiLineString value."
registry: "multi-line-string-input"
---
