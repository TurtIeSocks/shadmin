...
description: "Hooks and pure helpers for querying OpenStreetMap data and performing geometric operations. Used by <OsmFeatureSubtract>, <OsmFeatureAdd>, and <LineStringInput snapToRoads>, and available for custom workflows."
---
