---
title: "FeatureField"
description: "Read-only Leaflet map that renders a GeoJSON.Feature stored at a record field. Leaflet's L.geoJSON accepts Features directly, so this is a thin wrapper around the shared shape-field shell."
registry: "feature-field"
---
