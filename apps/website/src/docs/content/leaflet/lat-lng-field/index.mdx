---
title: "LatLngField"
description: "Read-only Leaflet map with a marker at the lat/lng pair read from the current record. Renders an empty-state panel when either coordinate is missing."
registry: "lat-lng-field"
---
