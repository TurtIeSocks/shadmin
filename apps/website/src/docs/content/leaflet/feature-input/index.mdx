---
title: "FeatureInput"
description: "Form input for drawing and editing a GeoJSON.Feature. Writes { type: \"Feature\", geometry, properties } to the form value; preserves properties across edits so attribute data isn't lost when the user reshapes the geometry."
registry: "feature-input"
---
