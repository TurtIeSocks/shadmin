---
title: "useGeomanRHF"
description: "Hook that bridges Geoman draw/edit/remove/cut events to a React Hook Form field. Manages a L.FeatureGroup that holds the in-progress geometry layers and serializes them back to GeoJSON on every change."
registry: "use-geoman-rhf"
---
