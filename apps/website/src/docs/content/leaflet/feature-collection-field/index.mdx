...
description: "Read-only Leaflet map that renders a GeoJSON.FeatureCollection stored at a record field. L.geoJSON renders the collection as a single multi-layer group — one layer per feature."
registry: "feature-collection-field"
---
