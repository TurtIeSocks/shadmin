---
title: "Custom Blocks"
description: "The block editor is open by design. Use defineBlock to author new block types and pass them to <BlockEditorInput> and <BlockDocField> via the blocks prop. There is no global registry — blocks are always explicit."
---
