...
`theme`/`lightTheme`/`darkTheme` prop and no `AdminTheme` type. See the [Themes](/docs/app-config/themes) page for the full catalogue and the authoring guide.
