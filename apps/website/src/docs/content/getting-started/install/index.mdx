---
title: "Installation"
description: "Install shadmin in any React framework — Next.js, Vite, React Router, or TanStack Start."
---
...
Next step: Read the [Quick Start Guide](/docs/getting-started/quick-start-guide/setup) to learn how to use the components in your admin app.
