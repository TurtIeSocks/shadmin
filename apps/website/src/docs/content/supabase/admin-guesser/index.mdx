---
title: "AdminGuesser"
description: "<AdminGuesser> is the one-line entry point for Supabase admins. It wraps the kit's <Admin> component with a Supabase data provider, auth provider, default login page, password-reset routes, and an auto-generated list of <Resource> elements derived from the Supabase OpenAPI schema."
---
