...
description: "Schema-aware drop-in <Edit>. Renders inputs based on the Supabase OpenAPI schema, with PostgREST @ilike filters wired up for <AutocompleteInput> references."
registry: "edit-guesser"
---
