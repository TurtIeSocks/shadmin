...
> `<html>`. See [ThemeMode Toggle](/docs/ui-layout/theme-mode-toggle). Each palette below
...
[Registry/MCP](/docs/misc/mcp) page), the short form works too:
...
[ThemeStudio](/docs/extras/theme-studio) component lets you tune these live in the browser
...
[`apps/website/src/demo/features/demos/themes.tsx`](https://github.com/TurtIeSocks/shadmin/blob/main/apps/website/src/demo/features/demos/themes.tsx).
