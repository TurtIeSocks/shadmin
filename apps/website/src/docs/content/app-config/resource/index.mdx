---
title: "Resource"
description: "<Resource> components define the CRUD routes of a shadmin application."
registry: "resource"
---
...
When users navigate to the `/orders` route, Shadmin will display the [`<Loading>`](/docs/ui-layout/loading) component while the `OrderList` component is being loaded.

![Loading](/docs/images/loading.png)

## `group`

Use `group` to organize resources in the default [`<Menu>`](/docs/ui-layout/menu):
