...
Monaco is lazy-loaded the same way as [`<MonacoJsonInput>`](/docs/editing/monaco-json-input).
...
- For List cells, use [`<JsonField>`](/docs/viewing/json-field) instead — it has no Monaco dependency.
