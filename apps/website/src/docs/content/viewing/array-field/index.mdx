---
title: "ArrayField"
description: "Renders an embedded array of objects. Creates a ListContext with the data so you can reuse list-aware child components (e.g. <SingleFieldList>, <DataTable>)."
registry: "array-field"
---
