---
title: "TreeList"
description: "<TreeList> renders a list of records as a hierarchical, expandable tree. Each record points to its parent via a configurable foreign-key field; root nodes have a null/undefined parent. Useful for nested categories, org charts, sitemaps, comment threads, and anything else with a parent–child relationship."
registry: "tree-list"
---
