---
title: "RichTextField"
description: "Renders an HTML string as rich text. The HTML is sanitized with DOMPurify and parsed into a React element tree with html-react-parser. This means no React HTML-injection escape hatch is used, and the field is safe from Cross-Site Scripting (XSS) attacks."
registry: "rich-text-field"
---
