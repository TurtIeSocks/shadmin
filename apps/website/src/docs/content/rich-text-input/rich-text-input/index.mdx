---
title: "RichTextInput"
description: "Optional rich text input for Shadmin. Includes the full Minimal TipTap block."
registry: "rich-text-input"
---

Use `<RichTextInput>` to edit rich text content in a WYSIWYG editor (TipTap) and store it as HTML.

![RichTextInput](/docs/images/rich-text-input.png)
