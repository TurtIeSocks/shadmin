...
- [`<SimpleFormConfigurable>`](/docs/editing/simple-form-configurable) for a ready-made configurable form
- [`<ColumnsButton>`](/docs/viewing/columns-button) for a non-inspector approach to column visibility
