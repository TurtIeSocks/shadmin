...
description: "Accessibility helper that lets keyboard users skip past the page chrome and jump directly to the main content."
registry: "skip-navigation-button"
---
