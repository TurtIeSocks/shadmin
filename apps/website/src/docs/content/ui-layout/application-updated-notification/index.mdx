...
description: "A floating banner that informs the user a new version of the application is available, with a button to reload the page."
registry: "application-updated-notification"
---

This is the default notification rendered by [`<CheckForApplicationUpdate>`](/docs/ui-layout/check-for-application-update), but it can also be used standalone.
