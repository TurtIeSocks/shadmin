---
title: "Offline"
description: "<Offline> renders its children only while the user is offline. With no children, it renders a default banner at the top of the viewport informing the user that the connection has been lost."
registry: "offline"
---
