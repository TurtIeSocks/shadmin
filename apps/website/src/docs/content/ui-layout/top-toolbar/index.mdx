---
title: "TopToolbar"
description: "Container for action buttons positioned at the top right of a view. Convenience wrapper that lays out toolbar items horizontally with end alignment and a small gap."
registry: "top-toolbar"
---
...
For the conventional Filter + Create + Export combo, use [`<ListActions>`](/docs/ui-layout/list-actions) instead — it composes the same buttons and reads the resource definition automatically.
