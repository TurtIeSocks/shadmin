---
title: "Placeholder"
description: "Tiny placeholder block used while data is loading. Renders an inline-flex <span> filled with the muted background colour so a row of fields keeps its height during a fetch."
