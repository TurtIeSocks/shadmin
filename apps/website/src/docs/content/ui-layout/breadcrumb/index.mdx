...
Default page components ([`<List>`](/docs/page-components/list/overview), [`<Show>`](/docs/page-components/show), [`<Edit>`](/docs/page-components/edit/overview), [`<Create>`](/docs/page-components/create)) automatically set the breadcrumb based on the current resource and action. For detail pages, it uses the [`<Resource recordRepresentation>`](/docs/app-config/resource) to display the current record.
