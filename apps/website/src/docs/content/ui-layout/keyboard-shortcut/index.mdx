...
description: "Displays a keyboard shortcut using styled <kbd> elements. Useful for menus, tooltips, or any UI element that needs to advertise a hotkey to users."
registry: "keyboard-shortcut"
---
