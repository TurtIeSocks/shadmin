---
title: "RefreshButton"
description: "Forces a data refresh by invalidating react-query's query cache. All the data displayed in the current page (lists, show views, etc.) will be refreshed."
registry: "refresh-button"
---

It also displays a loading indicator while the data fetching is in progress.

![Refresh Button](/docs/images/refresh-button.jpg)

## Usage

The default [`Layout`](/docs/ui-layout/layout) contains a `<RefreshButton>` in the top right corner.
