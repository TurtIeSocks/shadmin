...
description: "A standalone button that opens or closes the main sidebar."
registry: "sidebar-toggle-button"
---

## Usage

The default [`<Layout>`](/docs/ui-layout/layout) already includes a sidebar toggle in its header. `<SidebarToggleButton>` is meant for custom layouts where you need to place the toggle outside of that header slot:
