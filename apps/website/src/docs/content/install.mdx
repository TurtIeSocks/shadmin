...
`shadmin` is a React library of components for admin apps. You can install it with any React framework:
...
Next step: Read the [Quick Start Guide](./quick-start-guide) to learn how to use the components in your admin app.
