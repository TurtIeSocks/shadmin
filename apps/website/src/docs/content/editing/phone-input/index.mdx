---
title: "PhoneInput"
description: "Phone input that stores E.164 and renders a country selector plus a national-format text input. Uses libphonenumber-js for parsing."
registry: "phone-input"
---
