---
title: "ArrayInput"
description: "To edit arrays of data embedded inside a record, <ArrayInput> creates a list of sub-forms."
registry: "array-input"
---

![ArrayInput](/docs/images/array-input.png)
