...
description: "Card-grid input for selecting a subscription plan. One card per plan; clicking writes the plan id to the form field. Highlights the current plan and (optionally) a recommended one."
registry: "subscription-plan-picker"
---
...
See [`<SubscriptionPlanField>`](/docs/extras/subscription-plan-field). The `features`
