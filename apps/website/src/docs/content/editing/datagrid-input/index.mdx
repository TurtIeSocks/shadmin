---
title: "DatagridInput"
description: "Form input that renders a list of records in a table and lets the user select rows via row checkboxes. The field value is an array of selected record ids."
registry: "datagrid-input"
---
