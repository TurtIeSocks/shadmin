...
- [`<SelectInput>`](/docs/editing/select-input) renders a dropdown
- [`<RadioButtonGroupInput>`](/docs/editing/radio-button-group-input) renders a list of radio buttons

:::

:::tip
If you need to let users select more than one item in the list, check out the [`<AutocompleteArrayInput>`](/docs/editing/autocomplete-array-input) component.
:::
