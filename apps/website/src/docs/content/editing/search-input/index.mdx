---
title: "SearchInput"
description: "Decorated TextInput with a search icon; no label."
registry: "search-input"
---

## Usage

`<SearchInput>` is designed to be used as a search input in a [`<List filters>`](/docs/page-components/list/filtering-sorting#filter-button--form-combo) form.
