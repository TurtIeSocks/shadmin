...
description: "Four-eyes / segregation-of-duties approval button. Each click adds the current user's id to an approver array on the record; once the count reaches required, the status flips to approved. Self-approval is blocked."
registry: "dual-approval-button"
---
