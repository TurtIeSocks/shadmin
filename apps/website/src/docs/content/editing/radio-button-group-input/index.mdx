...
- [`<SelectInput>`](/docs/editing/select-input) for a dropdown select input
- [`<AutocompleteInput>`](/docs/editing/autocomplete-input) for an autocomplete input
