---
title: "DateTimeInput"
description: "<DateTimeInput> renders an HTML <input type=\"datetime-local\"> element, allowing users to enter a date and a time using a date picker."
registry: "date-time-input"
---

![DateTimeInput](/docs/images/date-time-input.png)
