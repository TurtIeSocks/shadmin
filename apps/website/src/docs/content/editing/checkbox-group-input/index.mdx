...
To fetch the options from another resource, wrap `<CheckboxGroupInput>` in a [`<ReferenceArrayInput>`](/docs/editing/reference-array-input):
...
- [`<SelectArrayInput>`](/docs/editing/select-array-input) for a dropdown multi-select
- [`<AutocompleteArrayInput>`](/docs/editing/autocomplete-array-input) for a searchable autocomplete
