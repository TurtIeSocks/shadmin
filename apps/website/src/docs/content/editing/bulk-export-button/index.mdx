...
description: "Exports only the currently selected records using dataProvider.getList(). To be used in a ListContext (e.g., inside a <DataTable>)."
registry: "bulk-export-button"
---
...
See the [`<List exporter>`](/docs/page-components/list/data-export#exported-data) documentation for details on the `exporter` function.
