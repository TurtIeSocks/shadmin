...
description: "Composite input for a webhook endpoint. Edits the URL, signing secret, and event-type subscriptions. Optionally renders a test-ping button."
registry: "webhook-endpoint-input"
---
