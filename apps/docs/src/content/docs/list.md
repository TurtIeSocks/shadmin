...
Here is a minimal example to display a list of users with a [`<DataTable>`](./data-table):
...
:::tip
You can also display filters as a sidebar thanks to the [`<ToggleFilterButton>`](./toggle-filter-button) component:
