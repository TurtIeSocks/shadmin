...
The `<Notification>` component is already included in the default [`<Layout>`](./layout). It will display notifications triggered with the [`useNotify`](https://marmelab.com/ra-core/usenotify/) hook.
