...
Toolbar that pairs an inline [`<FilterForm>`](./search-input) with a [`<ListActions>`](./list-actions) slot.
...
By default `<ListToolbar>` renders [`<ListActions>`](./list-actions) on the right. Pass a custom node to replace it, or `false` to hide the actions slot entirely:
