...
The default [`<Layout>`](./layout) already includes a sidebar toggle in its header. `<SidebarToggleButton>` is meant for custom layouts where you need to place the toggle outside of that header slot:
