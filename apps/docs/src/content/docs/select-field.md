...
`optionText` also accepts a React Element. Shadmin renders it once per choice, within a [`RecordContext`](https://marmelab.com/ra-core/userecordcontext/) containing the related choice. You can use Field components there.
...
- If you need to fetch the choices, you probably need a [`<ReferenceField>`](./reference-field) instead.
