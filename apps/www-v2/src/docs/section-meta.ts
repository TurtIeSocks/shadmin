...
export const SECTION_META: Record<string, { icon: LucideIcon; blurb: string }> = {
  ...
  viewing: { icon: Table2, blurb: "Tables, fields, and read-only views for presenting records." },
  editing: { icon: SquarePen, blurb: "Forms and inputs for creating and updating records." },
