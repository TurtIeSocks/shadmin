...
description: "Record-attached threaded discussion. Reads a comments sub-resource via useGetList, filtered by the parent record's id. Renders one card per comment plus a new-comment textarea."
registry: "comments-thread"
---
