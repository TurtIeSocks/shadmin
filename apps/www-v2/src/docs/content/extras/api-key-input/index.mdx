---
title: "ApiKeyInput"
description: "API-key rotation control. Renders a Rotate button that opens a confirmation dialog. On confirm, fires onRotate(record) if provided, or sets the source field to null so the server-side hook regenerates the key."
registry: "api-key-input"
---
