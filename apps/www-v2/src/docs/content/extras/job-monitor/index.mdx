---
title: "JobMonitor"
description: "Background job queue dashboard. Polls a jobs resource (or whichever you pass), groups rows by status, and exposes retry / cancel actions per row."
registry: "job-monitor"
---
