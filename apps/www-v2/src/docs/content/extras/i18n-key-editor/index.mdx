---
title: "I18nKeyEditor"
description: "Wraps an i18n provider so every missing-key lookup is captured and surfaced in a floating panel. Inline-edit translations; Export emits a JSON patch to the clipboard."
registry: "i18n-key-editor"
---
