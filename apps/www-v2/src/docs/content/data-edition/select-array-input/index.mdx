...
To fetch the options from another resource, wrap `<SelectArrayInput>` in a [`<ReferenceArrayInput>`](/docs/data-edition/reference-array-input):
...
- [`<CheckboxGroupInput>`](/docs/data-edition/checkbox-group-input) for an inline list of checkboxes (better for short lists)
- [`<AutocompleteArrayInput>`](/docs/data-edition/autocomplete-array-input) for a searchable autocomplete (better for very long lists)
