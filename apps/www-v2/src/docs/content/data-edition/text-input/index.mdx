---
title: "TextInput"
description: "Single-line or multiline text input. Wraps a Shadcn <Input> or <Textarea> depending on multiline."
registry: "text-input"
---
...
**Warning**: Do not use `type="number"`, or you'll receive a string as value (this is a [known React bug](https://github.com/facebook/react/issues/1425)). Instead, use [`<NumberInput>`](/docs/data-edition/number-input).
