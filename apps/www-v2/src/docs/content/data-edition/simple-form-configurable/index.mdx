...
| ...rest         | -        | `SimpleFormProps` | -                        | All other props are forwarded to the underlying [`<SimpleForm>`](/docs/data-edition/simple-form). |
...
- [`<SimpleForm>`](/docs/data-edition/simple-form) for the underlying form layout
