...
description: "Single-select input rendered as a list (column or row) of radio buttons."
registry: "radio-button-group-input"
---

![RadioButtonGroupInput](/docs/images/radio-button-group-input.png)
...
- [`<SelectInput>`](/docs/data-edition/select-input) for a dropdown select input
- [`<AutocompleteInput>`](/docs/data-edition/autocomplete-input) for an autocomplete input
