...
description: "Multi-select input rendered as a list (column or row) of checkboxes."
registry: "checkbox-group-input"
---
...
To fetch the options from another resource, wrap `<CheckboxGroupInput>` in a [`<ReferenceArrayInput>`](/docs/data-edition/reference-array-input):
...
- [`<SelectArrayInput>`](/docs/data-edition/select-array-input) for a dropdown multi-select
- [`<AutocompleteArrayInput>`](/docs/data-edition/autocomplete-array-input) for a searchable autocomplete
