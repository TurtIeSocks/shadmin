---
title: "ImageInput"
description: "<ImageInput> allows editing and uploading image attachments. It is a thin wrapper around <FileInput> that defaults to accepting only images and renders an <ImageField> thumbnail preview by default."
...
`<ImageInput>` accepts the same props as [`<FileInput>`](/docs/data-edition/file-input):
