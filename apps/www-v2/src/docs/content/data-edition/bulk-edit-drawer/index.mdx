...
description: "Side-panel form for editing multiple selected records in batch. Opens a right-side shadcn <Sheet> containing the supplied form children. On submit, applies the touched-fields diff to every record in useListContext().selectedIds."
registry: "bulk-edit-drawer"
---
