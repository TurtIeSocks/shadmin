---
title: "DateInput"
description: "Ideal for editing dates, <DateInput> renders an HTML <input type=\"date\"> element, that most browsers display as a date picker."
registry: "date-input"
---

<video controls autoPlay playsInline muted loop className="w-full aspect-720/420">
    <source src="/docs/images/date-input.mp4" type="video/mp4" />
