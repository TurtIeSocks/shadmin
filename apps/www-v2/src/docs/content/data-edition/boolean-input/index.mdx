---
title: "BooleanInput"
description: "Toggle switch for boolean values, leveraging shadcn's Switch component."
registry: "boolean-input"
---
...
:::tip
This input doesn't let users set a `null` value - only `true` or `false`. Use the [`<SelectInput>`](/docs/data-edition/select-input) component if you have to handle non-required booleans.
:::
