...
description: "<TranslatableInputs> lets you edit the same input in several languages, exposing one tab per locale. It is the editable counterpart of <TranslatableFields>."
registry: "translatable-inputs"
---
