---
title: "GeoJSONField"
description: "Polymorphic read-only Leaflet field that renders any GeoJSON geometry (Point, LineString, Polygon, Multi\\*, or GeometryCollection) stored at a record field."
registry: "geojson-field"
---
