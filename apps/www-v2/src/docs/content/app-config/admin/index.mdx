...
Reach for the pair when you need to inject a wrapping component between the providers and the routed UI — for example to mount the cmd+K [`<CommandMenu>`](/docs/extras/command-menu) palette:
