---
title: "MCP Server"
description: "Shadmin integrates seamlessly with AI agents through the Model Context Protocol (MCP). This integration enables your AI assistant to understand the Shadmin component library and generate admin interfaces more effectively. Two MCP servers can be used to provide the documentation to your AI agent:"
---
