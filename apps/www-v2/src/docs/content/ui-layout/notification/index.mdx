---
title: "Notification"
description: "A notification component based on Shadcn's sonner toasts, supporting undoable actions."
...
The `<Notification>` component is already included in the default [`<Layout>`](/docs/ui-layout/layout). It will display notifications triggered with the [`useNotify`](https://marmelab.com/ra-core/usenotify/) hook.
