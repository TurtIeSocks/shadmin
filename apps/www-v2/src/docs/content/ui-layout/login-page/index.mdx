---
title: "LoginPage"
description: "When Authentication is enabled, users must log in to access the admin interface. The login page is displayed automatically when an unauthenticated user tries to access a protected route."
registry: "login-page"
---
