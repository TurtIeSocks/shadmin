...
`<TabbedForm>` is often used as child of [`<Create>`](/docs/page-components/create) or [`<Edit>`](/docs/page-components/edit). Use `<TabbedForm.Tab>` components to define each tab.
