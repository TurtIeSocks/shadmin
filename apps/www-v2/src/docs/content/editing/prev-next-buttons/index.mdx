...
description: "Renders navigation buttons that link to the previous and next records of the current resource, plus the index/total."
registry: "prev-next-buttons"
---
