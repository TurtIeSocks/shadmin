...
| ...rest         | -        | `SimpleFormProps` | -                        | All other props are forwarded to the underlying [`<SimpleForm>`](/docs/editing/simple-form). |
...
- [`<SimpleForm>`](/docs/editing/simple-form) for the underlying form layout
