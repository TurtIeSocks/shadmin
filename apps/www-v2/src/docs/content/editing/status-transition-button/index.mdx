...
description: "FSM-aware status change button. Reads the record's current status, looks up allowed transitions in a config, optionally filters via guard predicates, and fires useUpdate on selection."
registry: "status-transition-button"
---
