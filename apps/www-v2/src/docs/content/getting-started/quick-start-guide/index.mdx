...
The columns are rendered by the [`<DataTable.Col>`](/docs/viewing/data-table#datatablecol) component. By default, it renders the value as a simple string. You can customize how each column is rendered by passing a custom React component as [the `field` prop](/docs/viewing/data-table#field).
