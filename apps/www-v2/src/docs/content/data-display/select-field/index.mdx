---
title: "SelectField"
description: "Displays the text for a value from a predefined list of choices."
registry: "select-field"
---
...
- If you need to fetch the choices, you probably need a [`<ReferenceField>`](/docs/data-display/reference-field) instead.
