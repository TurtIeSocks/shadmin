...
description: "Displays number of related records for a ReferenceMany relation."
registry: "reference-many-count"
---
...
:::tip
If you need to count all the records of a given resource, use [the `<Count>` component](/docs/data-display/count) instead.
:::
