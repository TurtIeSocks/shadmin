---
title: "JsonField"
description: "Lightweight read-only JSON formatter rendered as a <pre>. No Monaco dependency — safe to use in List cells or anywhere a heavy editor would be overkill."
---
...
No syntax highlighting in v1. If you need highlighting, use [`<MonacoJsonField>`](/docs/data-display/monaco-json-field).
