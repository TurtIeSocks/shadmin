...
description: "The default pagination component for List pages."
...
Other components that create a `ListContext`, like [`<ReferenceManyField>`](/docs/data-display/reference-many-field), don't include pagination by default. You can use `<ListPagination>` to add pagination to them:
