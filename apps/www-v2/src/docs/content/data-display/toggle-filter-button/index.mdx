...
description: "Enables or disable a particular filter in a list view."
registry: "toggle-filter-button"
---

![Toggle filter button](/docs/images/toggle-filter-button.png)
