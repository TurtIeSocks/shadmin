...
description: "Displays a related record from a one-to-one relationship by fetching the record whose target field matches the current record's id (or source)."
registry: "reference-one-field"
---
