---
title: "Show"
description: "The <Show> component is a page component that renders a single record."
registry: "show"
---

![product show view](/docs/images/product-show.png)
...
`<RecordField>` is a flexible wrapper to display a label and a value (field component, render function, or children) with optional layout variants. See [RecordField documentation](/docs/data-display/record-field) for details.
