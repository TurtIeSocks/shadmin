...
description: "Schema-aware drop-in <List> that introspects the Supabase OpenAPI schema to detect foreign keys (rendered as <ReferenceField>) and timestamps (rendered as <DateField>)."
registry: "list-guesser"
---
