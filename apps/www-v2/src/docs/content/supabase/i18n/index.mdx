---
title: "Supabase i18n"
description: "The Supabase components reference translation keys under the ra-supabase.* namespace. Each key has an inline English fallback via translate(key, { _: '...' }), so loading translations is optional."
---
