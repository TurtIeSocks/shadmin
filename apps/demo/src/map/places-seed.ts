...
const reservoir: Place = {
  ...
  alt_locations: {
    ...
    coordinates: [
      ...
      [-73.962, 40.7886], // north gatehouse
    ],
  },
  route: {
    type: "LineString",
...
const statueOfLiberty: Place = {
  ...
  geometries: {
    type: "GeometryCollection",
    geometries: [{ type: "Point", coordinates: [-74.0445, 40.6892] }],
  },
...
const prospectPark: Place = {
  ...
  alt_locations: {
    type: "MultiPoint",
    coordinates: [
      [-73.9701, 40.662], // The Bandshell
      [-73.965, 40.658], // Boathouse
      [-73.9719, 40.67], // Long Meadow
    ],
  },
  route: {
    type: "LineString",
...
const hudsonGreenway: Place = {
  ...
  area: null,
  bbox: [-74.018, 40.7, -73.995, 40.87],
  alt_locations: {
    type: "MultiPoint",
    coordinates: [
      [-74.0163, 40.7042], // Battery Park
      [-74.0095, 40.7589], // Pier 84
      [-73.9988, 40.82], // Riverside Park
    ],
  },
  route: {
    type: "LineString",
