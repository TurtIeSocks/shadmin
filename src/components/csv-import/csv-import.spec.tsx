...
describe(
  ...
  () => {
    ...
    it(
      "auto-matches CSV headers to schema fields",
      async () => {
    ...
    it(
      "validates rows against schema and shows valid/error counters",
      async () => {
    ...
    it(
      "parses an uploaded CSV file and shows row count",
      async () => {
        const screen = render(<Basic />);
        await screen.getByRole("button", { name: /import/i }).click();
    ...
    it(
      "shows the error download button after commit when errors exist",
      async () => {
