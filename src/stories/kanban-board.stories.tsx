...
const data = {
  tasks: [
    ...
    { id: 2, title: "API integration", status: "doing", description: "Connect to REST endpoints" },
    { id: 3, title: "Write tests", status: "todo", description: "Unit + integration coverage" },
    { id: 4, title: "Deploy to staging", status: "doing", description: "Vercel preview environment" },
