...
const data = {
  posts: [
    { id: 1, title: "UI & Layout/TopToolbar", author: "Leo Tolstoy" },
    { id: 2, title: "UI & Layout/TopToolbar", author: "Jane Austen" },
    { id: 3, title: "UI & Layout/TopToolbar", author: "Oscar Wilde" },
  ],
};
