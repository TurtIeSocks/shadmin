...
export default {
  title: "UI & Layout/ListActions",
};

const data = {
  posts: [
    { id: 1, title: "UI & Layout/ListActions", author: "Leo Tolstoy" },
    { id: 2, title: "UI & Layout/ListActions", author: "Jane Austen" },
    { id: 3, title: "UI & Layout/ListActions", author: "Oscar Wilde" },
  ],
};
