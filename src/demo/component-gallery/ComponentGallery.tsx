...
const galleryComponents: GalleryComponent[] = [
  ...
  // Tier 1–4 additions (alpha-sorted block; integrate into main alpha order later)
  { name: "ApiKeyField", family: "Fields", docs: "ApiKeyField" },
  { name: "ApiKeyInput", family: "Inputs", docs: "ApiKeyInput" },
  { name: "ApprovalQueue", family: "Views", docs: "ApprovalQueue" },
  { name: "BulkEditDrawer", family: "Inputs", docs: "BulkEditDrawer" },
  { name: "ColorField", family: "Fields", docs: "ColorField" },
  { name: "ColorInput", family: "Inputs", docs: "ColorInput" },
  { name: "CommentsThread", family: "Views", docs: "CommentsThread" },
  { name: "CronField", family: "Fields", docs: "CronField" },
